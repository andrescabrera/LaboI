...
public class DesktopApplication2View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication2.Facturas f = new desktopapplication2.Facturas();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication2.Facturas> toRemove = new ArrayList<desktopapplication2.Facturas>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication2.Facturas f = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(f);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication2.Facturas> merged = new ArrayList<desktopapplication2.Facturas>(list.size());
                for (desktopapplication2.Facturas f : list) {
    ...
    private void initComponents() {
        ...
        nroFactLabel = new javax.swing.JLabel();
        totalLabel = new javax.swing.JLabel();
        fechaLabel = new javax.swing.JLabel();
        nrocliCLIENTESLabel = new javax.swing.JLabel();
        nroFactField = new javax.swing.JTextField();
        totalField = new javax.swing.JTextField();
        fechaField = new javax.swing.JTextField();
        nrocliCLIENTESField = new javax.swing.JTextField();
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nroFact}"));
        columnBinding.setColumnName("Nro Fact");
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${nrocliCLIENTES}"));
        columnBinding.setColumnName("Nrocli CLIENTES");
        columnBinding.setColumnClass(Integer.class);
        bindingGroup.addBinding(jTableBinding);

        masterScrollPane.setViewportView(masterTable);

        nroFactLabel.setText(resourceMap.getString("nroFactLabel.text")); // NOI18N
        nroFactLabel.setName("nroFactLabel"); // NOI18N
        ...
        nrocliCLIENTESLabel.setText(resourceMap.getString("nrocliCLIENTESLabel.text")); // NOI18N
        nrocliCLIENTESLabel.setName("nrocliCLIENTESLabel"); // NOI18N

        nroFactField.setName("nroFactField"); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nroFact}"), nroFactField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), nroFactField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        nrocliCLIENTESField.setName("nrocliCLIENTESField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nrocliCLIENTES}"), nrocliCLIENTESField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), nrocliCLIENTESField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nroFactLabel)
                    .addComponent(totalLabel)
                    .addComponent(fechaLabel)
                    .addComponent(nrocliCLIENTESLabel))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nroFactField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    ...
                    .addComponent(nrocliCLIENTESField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nroFactLabel)
                    .addComponent(nroFactField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(totalLabel)
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nrocliCLIENTESLabel)
                    .addComponent(nrocliCLIENTESField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveButton)
                    .addComponent(refreshButton)
    ...
    private java.util.List<desktopapplication2.Facturas> list;
    private javax.swing.JPanel mainPanel;
    private javax.swing.JScrollPane masterScrollPane;
    private javax.swing.JTable masterTable;
    private javax.swing.JMenuBar menuBar;
    private javax.swing.JButton newButton;
    private javax.swing.JTextField nroFactField;
    private javax.swing.JLabel nroFactLabel;
    private javax.swing.JTextField nrocliCLIENTESField;
    private javax.swing.JLabel nrocliCLIENTESLabel;
